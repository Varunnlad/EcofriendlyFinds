...
public class pro3 extends javax.swing.JFrame {
    ...
    try {
        ...
        ResultSet resultSet = statement.executeQuery("SELECT web1 FROM display WHERE productid='12'");
    ...
    try {
        ...
        // Query to fetch the link for the current product from the database
        ResultSet resultSet = statement.executeQuery("SELECT web2 FROM display WHERE productid='12'");
