...
public class pro4 extends javax.swing.JFrame {
    ...
    try {
        ...
        ResultSet resultSet = statement.executeQuery("SELECT web1 FROM display WHERE productid='13'");
    ...
    try {
        ...
        // Query to fetch the link for the current product from the database
        ResultSet resultSet = statement.executeQuery("SELECT web2 FROM display WHERE productid='13'");
